...
\cvname{Teddy Bear}
% job title/career
\cvjobtitle{Data Scientist,\\[0.2em] Panda of the Year}
...
\addtofrontsidebar{
	...
	\profilesection{Social Network}
		\begin{icontable}{2.5em}{1em}
			\social{\aiOverleafSquare}
				{https://www.researchgate.net/latex/templates/forty-seconds-cv/pztcktmyngsk}
				{Researchgate Link}
			\social{\faGithub}
	...
	\profilesection{Languages}
        ...
        \pointskill{\flag{SP.png}}{Spanish}{3}
