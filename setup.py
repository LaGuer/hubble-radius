...
setup(
    name="hubble-radius",
    version=import_module("hubble-radius").__version__,
    description=(
        "A table for creating and editing publication ready "
    ...
    classifiers=[
        ...
        "Intended Audience :: Astrophysics and Cosmology",
